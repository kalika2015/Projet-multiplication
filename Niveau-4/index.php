...
<html lang="fr">
<head>
    <title>Atelier PHP - Étape 4</title>
                ...
                if (!empty($_POST) && isset($_POST['check']))
                    foreach ($_POST['check'] as $table) :
                        ...
                        for ($i = 0; $i < 5; $i++) :
                            ...
                            <p>Combien font <?php echo $table?> x <?php echo $num?> ?</p>
                            <input type="text" name="saisie[]">
                            <input type="hidden" name="result[]" value="<?= $result ?>">
                            <input type="hidden" name="question[]" value="Combien font <?php echo $table?> x <?php echo $num?> ?">

                        <?php endfor ?>
                        <br>
                        <div class='action_buttons'>
                            <div class='button'>
                                <input type='submit' id="validmultiple" value='Valider la réponse'>
                            </div>
                        </div>
                    <?php endforeach ?>
            </div>
